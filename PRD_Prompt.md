...
**Project Name:** `Pitstop AI`
**App Type / Goal:** `Interactive F1 race replay and analysis tool featuring 3D animated track visualization with real-time car positions, live leaderboard, and AI-powered race analyst chatbot with Martin Brundle persona`
**Platform:** `WEB`
**Constraints (if any):** `Next.js 14+, Tailwind CSS, Three.js / React Three Fiber, Vercel AI SDK, TypeScript`
**Special Notes:** `AI integration using OpenAI API with Martin Brundle pit-lane expert persona. External data integration via OpenF1 API (free, no auth). Jarvis/Iron Man HUD visual aesthetic with dark backgrounds and cyan/teal accent glows. Target 5-10 hour build time.`
...
Briefly explain what `Pitstop AI` is and why it exists.
Format example:
